...
ylabel(axA, 'Log scaled reaction time','FontSize',labelFS);
...
legend(axA, {sprintf('Without active SI mean (n=%d)', S.Death.n0), ...
             sprintf('With active SI mean (n=%d)', S.Death.n1)}, ...
       'FontSize',legendFS,'Location','best');

set(fA, 'PaperPositionMode','auto');
% --- P-value line + stars (A) ---
add_pvalue_line_and_stars(axA, [4], [1]);
...
ylabel(axB, 'Log scaled reaction time','FontSize',labelFS);
...
legend(axB, {sprintf('Without active SI mean (n=%d)', S.Life.n0), ...
             sprintf('With active SI mean (n=%d)', S.Life.n1)}, ...
       'FontSize',legendFS,'Location','best');
...
legend(axC, {sprintf('Without active SI mean (n=%d)', S.Death.n0), ...
             sprintf('With active SI mean (n=%d)', S.Death.n1)}, ...
       'FontSize',legendFS,'Location','best');
...
legend(axD, {sprintf('Without active SI mean (n=%d)', S.Life.n0), ...
             sprintf('With active SI mean (n=%d)', S.Life.n1)}, ...
       'FontSize',legendFS,'Location','best');
