...
%FREUD_AUTOCORR_ENGINE  Compute trial/block ACFs and plot group-mean ACF curves.
%
...
%
% Usage:
%   out = Freud_Autocorr_Engine(X,G,'DoTrialACF',false,'DoBlockACF',true,'MaxLagBlock',8);
%
% Notes:
