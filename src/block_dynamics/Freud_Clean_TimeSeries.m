function [x_filled, mu_global] = Freud_Clean_TimeSeries( ...
    x, isClipped, thr, win, doPreDemean)
%FREUD_CLEAN_TIMESERIES  Impute missing/censored time series and estimate mean.
%
%   [x_filled, mu_global] = Freud_Clean_TimeSeries(x, isClipped, thr, win, doPreDemean)
%
%   Inputs:
...
%
%   Typical usage:
%       [x_filled, mu] = Freud_Clean_TimeSeries(x, isClipped, thr);
