...
% Generate the ROC model-comparison panel for Figure 4B.
%
% This script compares six LOOCV classifiers:
%   1. Learned block-space projection, J = 1, 2, 3
%   2. Fixed-PC block-space projection, J = 1, 2, 3
%
% It exports the Figure 4B ROC comparison panel and saves the J=2
% learned-projection model outputs for downstream visualization scripts.
%
% Required input:
...
fprintf('Saved all ROC curves/data to: Freud_ROC_Comparison_Data.mat\n');
