...
% Diagnostic spectral-density analysis of processed BDIAT time series.
%
% This script computes participant-level multitaper power spectral densities
% from the processed reaction-time series, compares SI groups across
% frequency bins, and reports Bonferroni-adjusted per-bin t-tests.
%
% This script is intended as a diagnostic/supplementary analysis and is not
% part of the main Figure 2 or Figure 4 generation pipeline.
%
% Required input:
...
%
% Plots:
%   1. Group mean PSD with SEM shading
%   2. Group mean log10(PSD) with SEM shading
%   3. Raw and Bonferroni-adjusted p-values by frequency
%   4. t-statistics by frequency
%
% Output:
%   results structure in workspace

load('Freud_Processed_BDIAT.mat')

%% -------------------- USER SETTINGS --------------------
fs   = 1;     % Sampling rate in trial-index units.
...
%% Store numerical results in workspace
results = struct();
results.f = f;
results.Pxx = Pxx;
