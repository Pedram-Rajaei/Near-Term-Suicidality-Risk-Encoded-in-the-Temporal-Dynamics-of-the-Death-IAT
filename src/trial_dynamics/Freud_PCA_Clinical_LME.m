...
% Clinical mixed-effects analysis for trial-level reaction-time dynamics.
%
% This script:
%   1. Loads processed BDIAT trial-level data.
%   2. Computes subject-level trial-position summaries for:
%        - Death + Me trials
%        - Life + Me trials
%   3. Fits a linear mixed-effects model for each condition:
%        ScaleRT ~ Group * Trial + (1 | Subject)
%   4. Computes planned group contrasts for early trial positions.
%   5. Saves the statistical results without generating any figures.
%
% Required input:
...
%
% Output:
%   Freud_PCA_Clinical_LME_Results.mat
