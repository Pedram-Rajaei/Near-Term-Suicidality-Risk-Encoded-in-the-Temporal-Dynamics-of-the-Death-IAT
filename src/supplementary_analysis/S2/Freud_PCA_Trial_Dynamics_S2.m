%% Freud_PCA_Loading_Tests_S2.m
% Trial-wise statistical tests of PC1 and PC2 loading entries for Figure S2.
%
...
%
%   Figure_S2_A.svg : q-values for PC1 loading entries
%   Figure_S2_B.svg : q-values for PC2 loading entries
%
% Required input:
...
% ---- export PC1 (Figure_S2_A.svg) ----
exportS2panel('Figure_S2_A.svg', xAxis, q_pc1, alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(PC1)'}, labelFS, tickFS, legendFS);

% ---- export PC2 (Figure_S2_B.svg) ----
exportS2panel('Figure_S2_B.svg', xAxis, q_pc2, alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(PC2)'}, labelFS, tickFS, legendFS);

disp('Saved SVGs: Figure_S2_A.svg and Figure_S2_B.svg');

% ---------------- local helpers ----------------
function exportS2panel(outSvg, xAxis, qVals, yl_alpha, W, H, xlab, ylab, legTxt, labelFS, tickFS, legendFS)
