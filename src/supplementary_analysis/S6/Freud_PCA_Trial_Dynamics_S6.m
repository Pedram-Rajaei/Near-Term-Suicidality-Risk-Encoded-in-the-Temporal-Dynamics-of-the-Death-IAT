%% Freud_Trial_Dynamics_TTest_S6.m
% Trial-wise statistical tests for Figure S6.
%
...
%
%   Figure_S6_A.svg : Death + Me rowMean q-values
%   Figure_S6_B.svg : Life + Me rowMean q-values
%   Figure_S6_C.svg : Death + Me rowEV/PC1 q-values
%   Figure_S6_D.svg : Life + Me rowEV/PC1 q-values
%
% Required input:
...
% Figure formatting for exported S6 panels.
labelFS  = 24;
tickFS   = 20;
legendFS = 20;
...
for sIdx = 1:numel(startSets)
    ...
    % Store FDR-adjusted q-values for Figure S6 export.
...
%% Export Figure S6 panels
assert(isfield(S,'Death_ttest') && isfield(S,'Life_ttest'), ...
    'Need S.Death_ttest and S.Life_ttest stored before exporting Figure_S6 SVGs.');
...
% helper: one exporter
exportS6panel('Figure_S6_A.svg', xAxis, S.Death_ttest.q_mean, yl_alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(rowMean)'}, labelFS, tickFS, legendFS);

exportS6panel('Figure_S6_B.svg', xAxis, S.Life_ttest.q_mean, yl_alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(rowMean)'}, labelFS, tickFS, legendFS);

exportS6panel('Figure_S6_C.svg', xAxis, S.Death_ttest.q_ev, yl_alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(rowEV)'}, labelFS, tickFS, legendFS);

exportS6panel('Figure_S6_D.svg', xAxis, S.Life_ttest.q_ev, yl_alpha, W, H, ...
    'Trial index', 'q-value', {'qFDR(rowEV)'}, labelFS, tickFS, legendFS);

disp('Saved t-test SVGs: Figure_S6_A.svg, Figure_S6_B.svg, Figure_S6_C.svg, Figure_S6_D.svg');

%% ---------------- local helper functions ----------------
function exportS6panel(outSvg, xAxis, qVals, yl_alpha, W, H, xlab, ylab, legTxt, labelFS, tickFS, legendFS)
