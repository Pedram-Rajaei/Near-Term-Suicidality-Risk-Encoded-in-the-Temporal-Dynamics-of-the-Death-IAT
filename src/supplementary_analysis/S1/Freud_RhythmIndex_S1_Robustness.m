%% Freud_RhythmIndex_S1_Robustness.m
% Rhythm-index robustness analysis for Figure S1.
%
...
%% --------------------------- Export figures ----------------------------
export_s1_panel(main,   'destroy',  fullfile(outDir,'Figure_S1_A.svg'));
export_s1_panel(main,   'preserve', fullfile(outDir,'Figure_S1_B.svg'));
export_s1_panel(online, 'destroy',  fullfile(outDir,'Figure_S1_C.svg'));
export_s1_panel(online, 'preserve', fullfile(outDir,'Figure_S1_D.svg'));

%% --------------------------- Save results ------------------------------
save(fullfile(outDir,'rhythm_s1_results.mat'), 'main', 'online');

fprintf('\nSaved results to: %s\n', fullfile(outDir,'rhythm_s1_results.mat'));
fprintf('Saved figures:\n');
fprintf('  %s\n', fullfile(outDir,'Figure_S1_A.svg'));
fprintf('  %s\n', fullfile(outDir,'Figure_S1_B.svg'));
fprintf('  %s\n', fullfile(outDir,'Figure_S1_C.svg'));
fprintf('  %s\n', fullfile(outDir,'Figure_S1_D.svg'));
...
function export_s1_panel(S, mode, outFile)
...
switch lower(mode)
    case 'destroy'
        ...
        xLabelText = '$\Delta \mathrm{RI} = \mathrm{RI}_{\mathrm{obs}} - \mathrm{mode}(\mathrm{RI}_{\mathrm{null}})$';
